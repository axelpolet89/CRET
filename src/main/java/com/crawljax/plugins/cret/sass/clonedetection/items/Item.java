...
import com.crawljax.plugins.cret.sass.clonedetection.ClonedDeclaration;
...
public class Item implements Set<ClonedDeclaration>, Cloneable, Comparable<Item>
{
    ...
    /**
     * Creates new Item using the given {@link com.crawljax.plugins.cret.sass.clonedetection.ClonedDeclaration} object.
     * @param declaration
     */
